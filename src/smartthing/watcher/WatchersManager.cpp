...
namespace Watcher {
    ...
    DynamicJsonDocument WatchersManager::getWatcherCallbacksInfo(const char * type, const char * name) {
        ...
        LOGGER.error(WATCHERS_MANAGER_TAG, "Watcher with type %s and index %d not found!", type, index);
